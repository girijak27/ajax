...
$.ajax({
    ...
    for(var i=0; i<resp.data.length; i++){
        tbl += '<tr><td>'+ resp.data[i].id + '</td><td>' + resp.data[i].employee_name + '</td><td>' + resp.data[i].employee_salary + '</td><td>' + resp.data[i].employee_age + '</td><td>' + resp.data[i].profile_image + '</td></tr>';
    }
